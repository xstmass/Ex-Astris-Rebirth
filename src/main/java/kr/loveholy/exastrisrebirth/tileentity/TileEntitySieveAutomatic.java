...
public class TileEntitySieveAutomatic extends TileEntity implements
    ...
    private final int energyPerCycle = ExAstrisRebirthData.sieveAutomaticBaseEnergy;// config
    ...
    public boolean isUseableByPlayer(EntityPlayer par1EntityPlayer) {
        return worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord) == this && par1EntityPlayer.getDistanceSq((double) this.xCoord + 0.5D,
    ...
    public boolean isItemValidForSlot(int slot, ItemStack item) {
        ...
        // &&
        return SieveRegistry.registered(Block.getBlockFromItem(item.getItem()),
                item.getItemDamage())
                && slot == 0;
    }
