...
public class ModChisel {
    ...
    public static void addSieveRegistry() {
        if (ExAstrisRebirthData.allowChiselBlocksFromSifting) {
            ...
            GameRegistry.addRecipe(new ItemStack(GameRegistry.findItem("chisel", "marble"), 1, 0), "aa", "aa", 'a', new ItemStack(ExAstrisRebirthItem.itemChiselStone, 1, 0));
            GameRegistry.addRecipe(new ItemStack(GameRegistry.findItem("chisel", "limestone"), 1, 0), "aa", "aa", 'a', new ItemStack(ExAstrisRebirthItem.itemChiselStone, 1, 1));
        }
    }
